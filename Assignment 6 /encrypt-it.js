...
(function() {
  ...
  function handleClick() {
    ...
    let inputText = document.getElementById("input-text").value.trim(); // Trim leading/trailing spaces
    let encryptedText = shiftCipher(inputText);
    document.getElementById("result").textContent = encryptedText + " 🔐"; // Slightly different output
  }
